...
// const additionalTickets: SupportTicket[] = [
//   {
//     id: 'TICKET002',
//     userId: 'U002',
//     userName: 'Jane Smith',
//     subject: 'Unable to add money to wallet',
//     message: 'I am trying to add ₹1000 to my wallet but the payment is getting stuck at UPI gateway',
//     status: 'in_progress',
//     priority: 'medium',
...
//     message: 'My KYC documents were rejected. Can you please tell me what went wrong?',
//     status: 'resolved',
//     priority: 'low',
//     createdAt: '2024-01-17T16:45:00Z',
//     assignedTo: 'Support Agent 2',
//     response: 'Document quality was poor. Please upload clear, high-resolution images.'
//   }
// ];

// export const Support = () => {
//   const [tickets, setTickets] = useState([...mockSupportTickets, ...additionalTickets]);
...
//   const updateTicketStatus = (ticketId: string, newStatus: 'open' | 'in_progress' | 'resolved') => {
...
//     };
//     return colors[status as keyof typeof colors] || 'text-muted-foreground bg-muted/10 border-border';
//   };
