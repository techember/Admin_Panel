          ...
          <div className="mt-8 pt-6 border-t border-border">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <div className="flex justify-between">
                <span>Email:</span>
                <code className="text-foreground bg-muted px-2 py-1 rounded">admin@example.com</code>
              </div>
              <div className="flex justify-between">
                <span>Password:</span>
                <code className="text-foreground bg-muted px-2 py-1 rounded">admin123</code>
              </div>
              <div className="flex justify-between">
                <span>MPIN:</span>
                <code className="text-foreground bg-muted px-2 py-1 rounded">1234</code>
              </div>
            </div>
          </div>
        </div>
