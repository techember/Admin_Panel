...
//   const quickActions = [
//     { title: 'Wallet Management', icon: WalletIcon, action: () => console.log('Wallet') },
//     { title: 'Transaction History', icon: ClockIcon, action: () => console.log('History') },
//     { title: 'Cashback Campaigns', icon: CurrencyDollarIcon, action: () => console.log('Cashback') },
//     { title: 'Refer & Earn', icon: UserPlusIcon, action: () => console.log('Refer') }
//   ];
...
//             <ChartContainer config={chartConfig} className="h-64">
//               <ResponsiveContainer width="100%" height="100%">
//                 <AreaChart data={mockChartData.walletLoads}>
//                   <CartesianGrid strokeDasharray="3 3" />
//                   <XAxis dataKey="day" />
//                   <YAxis />
//                   <ChartTooltip content={<ChartTooltipContent />} />
...
const StatCard = ({ 
  title, value, growth, icon: Icon, trend = 'up'
}: { 
  title: string; 
  value: string | number; 
  growth: number; 
  ...
  return (
    <AdminLayout title="Dashboard">
      <div className="p-6 space-y-6">
        {/* Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <StatCard title="Total Users" value={stats.totalUsers.toLocaleString()} growth={stats.userGrowth} icon={UsersIcon} />
          <StatCard title="Transactions" value={stats.totalTransactions.toLocaleString()} growth={stats.transactionGrowth} icon={CreditCardIcon} />
          <StatCard title="Revenue" value={`₹${stats.totalRevenue.toLocaleString()}`} growth={stats.revenueGrowth} icon={BanknotesIcon} />
          <StatCard title="Pending KYC" value={stats.pendingKyc} growth={stats.kycGrowth} icon={DocumentCheckIcon} trend="down" />
        </div>
