                    ...
                    <div key={campaign.id} className="border border-border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">₹{campaign.minTransaction}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Max Cashback:</span>
                          <p className="font-medium">₹{campaign.maxCashback}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Valid Until:</span>
                          <p className="font-medium">{new Date(campaign.validUntil).toLocaleDateString()}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Total Users:</span>
                          <p className="font-medium">{campaign.totalUsers.toLocaleString()}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Total Cashback:</span>
                          <p className="font-medium text-success">₹{campaign.totalCashback.toLocaleString()}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Status:</span>
                          <p className={`font-medium ${campaign.active ? 'text-success' : 'text-muted-foreground'}`}>
