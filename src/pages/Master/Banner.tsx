...
// import { PlusIcon, ChevronLeftIcon, ChevronRightIcon, PencilSquareIcon, TrashIcon, LinkIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
//   const [newBanner, setNewBanner] = useState<{ imageFile?: File | null; section: string; type: string; link: string }>({
//     imageFile: null,
//     section: '',
//     type: '',
//     link: ''
...
//   const handleSubmit = () => {
//     if (!validate()) return;
//     const imageUrl = newBanner.imageFile ? URL.createObjectURL(newBanner.imageFile) : '/placeholder.svg';
...
//                         <img src={item.imageUrl} alt={`${item.section} ${item.type}`} className="h-10 w-10 object-cover" />
//                       </div>
//                     </td>
...
//                   Showing {startIndex + 1} to {endIndex} of {banners.length} results
//                 </p>
//                 <div className="flex items-center gap-2">
//                   <button
...
//                   type="file"
//                   accept="image/*"
//                   onChange={(e) => setNewBanner({ ...newBanner, imageFile: e.target.files?.[0] || null })}
...
//                   className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary ${errors.section ? 'border-destructive' : 'border-border'}`}
//                 >
...
//                   className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary ${errors.type ? 'border-destructive' : 'border-border'}`}
